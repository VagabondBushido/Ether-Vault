...
import "./VagabondCoin.sol";
contract Staking{
    mapping(address => uint256) public Balances;
    mapping(address => uint256) public unclaimedRewards;
    mapping(address => uint256) public lastStakedTime;

     VagabondCoin public vagabondCoin;

      constructor(address _vagabondCoinAddress) {
        vagabondCoin = VagabondCoin(_vagabondCoinAddress);
    }
    ...
    function claimRewards() public{
        ...
        vagabondCoin.mint(msg.sender, totalRewards);
